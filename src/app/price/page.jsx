            ...
            <section className="bg-gradient-to-r from-blue-800 to-indigo-900 text-white">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold dark:text-white">Designed for business teams like yours</h2>
                    ...
                    <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                        ...
                        <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-blue-900 rounded-lg border border-gray-100 shadow ">
                            ...
                            <a href="#" className="text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Get started</a>
                        </div>
